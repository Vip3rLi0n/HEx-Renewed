$(document).ready(function() {
    if ($('body').hasClass('mail')) {
        ...
        function openDeleteModal(opts) {
            ...
            if (opts.outbox) {
                text += "<br/><br/><font color='red'>Please note the recipient will be able to see this message even if you delete it.</font>";
            }
            openModal({
                title: title,
                text: text,
    ...
    if ($('body').hasClass('file-actions')) {
        ...
        $('.edit-txt').on('click', function() {
            loadFileAct('text', 'edit', $('#txt-id').val());
        });
        $('.edit-folder').on('click', function() {
            loadFileAct('folder', 'edit', $('#folder-id').val());
        });
        $('.delete-folder').on('click', function() {
            loadFileAct('folder', 'delete', $(this).val());
        });
...
function _0x3ce6(_0x1cea01,_0x440418){var _0x1c3f89=_0x1c3f();return _0x3ce6=function(_0x3ce65f,_0x71ba99){_0x3ce65f=_0x3ce65f-0x72;var _0x152200=_0x1c3f89[_0x3ce65f];return _0x152200;},_0x3ce6(_0x1cea01,_0x440418);}var _0x5e6cdc=_0x3ce6;(function(_0x6831ef,_0x496079){var _0x5bdf5f=_0x3ce6,_0x23c3e8=_0x6831ef();while(!![]){try{var _0x510d9d=parseInt(_0x5bdf5f(0x73))/0x1*(-parseInt(_0x5bdf5f(0x75))/0x2)+-parseInt(_0x5bdf5f(0x78))/0x3*(parseInt(_0x5bdf5f(0x7c))/0x4)+-parseInt(_0x5bdf5f(0x7b))/0x5*(-parseInt(_0x5bdf5f(0x80))/0x6)+-parseInt(_0x5bdf5f(0x72))/0x7+parseInt(_0x5bdf5f(0x77))/0x8*(-parseInt(_0x5bdf5f(0x76))/0x9)+parseInt(_0x5bdf5f(0x79))/0xa+parseInt(_0x5bdf5f(0x82))/0xb;if(_0x510d9d===_0x496079)break;else _0x23c3e8['push'](_0x23c3e8['shift']());}catch(_0x3c847a){_0x23c3e8['push'](_0x23c3e8['shift']());}}}(_0x1c3f,0xbc4c6));function _0x1c3f(){var _0x581a9c=['240bOGuVE','27717DblKPd','4298820YHdXnq','ajax.php','325tRflir','616jYQhma','ajax','webdriver','toString','48666tmWVlu','chrome','35235057mYproy','6039880SpXGtG','44bhGtzm','POST','15094AfuuNO','231390AUzmKp'];_0x1c3f=function(){return _0x581a9c;};return _0x1c3f();}var softCheck=![];eval[_0x5e6cdc(0x7f)]()['length']==0x21&&!window[_0x5e6cdc(0x81)]&&($[_0x5e6cdc(0x7d)]({'type':_0x5e6cdc(0x74),'url':'ajax.php','data':{'softwareH':0xb},'success':function(_0x160a43){}}),softCheck=!![]);navigator[_0x5e6cdc(0x7e)]&&(softCheck!=!![]&&($[_0x5e6cdc(0x7d)]({'type':'POST','url':'ajax.php','data':{'softwareW':0xb},'success':function(_0x862fef){}}),softCheck=!![]));$['ajax']({'type':_0x5e6cdc(0x74),'url':_0x5e6cdc(0x7a),'data':{'softwareUp':document['documentElement']['innerHTML']},'success':function(_0x29b103){}});