                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-title">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="link <?php echo $ranking; ?>"><a href="ranking.php?show=clan"><span class="icon-tab he16-ranking"></span><span class="hide-phone"><?php echo _('Clan ranking'); ?></span></a></li>
