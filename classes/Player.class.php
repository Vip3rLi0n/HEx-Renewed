...
?>
                                                ...
                                                <tbody>
<?php
require '../fame/'. ($this->curRound - 1) .'_'.$pathName.'_preview.html';
?>
                                                </tbody>
                                            </table>
                                        </div>
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content padding noborder">
                                ...
                                foreach ($rows as $row) {
                                    ...
                                    $content = "$dateCreated: `$description`<br>- `$text`";

                                    echo "<div class='span7'>$content</div>";
                                }
                                foreach ($rows as $row) {
                                    $author = $row['author'];

                                    echo "<div class='span5'>By: $author</div>";
                                }
                                ?>
                        </div>
        ...
        ?>     
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-title">
                                <span class="icon"><i class="fa fa-arrow-right"></i></span>
                                <h5><?php echo _("Changelog"); ?></h5>
                            </div>
          
                            <div class="widget-content padding noborder">
                                <?php
                                $sql = "SELECT `dateCreated`, description, `text`, `author` FROM changelog ORDER BY id ASC";
                                $stmt = $this->pdo->query($sql);
                                $rows = $stmt->fetchAll(PDO::FETCH_ASSOC);

                                foreach ($rows as $row) {
                                    $dateCreated = @new DateTime($row['dateCreated']);
                                    $formattedDate = $dateCreated->format('Y-m-d');
                                    $description = $row['description'];
                                    $text = $row['text'];
                                    $author = $row['author'];

                                    $content = "<b>$formattedDate:</b> <i>$description</i>  ( <strong>$author</strong> )<br>- <strong>$text</strong>";

                                    echo "<br><div class='span100'><div class='span7'>$content</div></div><br>";
                                }
                                ?>
                            </div>
                ...
                ?>
                            ...
                            <div class="widget-box">
                                ...
                                <div class="widget-title">
                                    ...
                                    <a href="ranking.php"><span class="hide-phone label"><?php echo _("View ranking"); ?></span></a>
                                </div>
                ...
                ?>
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-title">
                                ...
                                <a href="news"><span class="label"><?php echo _("View all"); ?></span></a>                                                    
                            </div>                                    
...
?>
    ...
    public function ip_info()
    {
        ...
        if (is_array($ipInfo)) {
            ...
            // Handle the case where $ipInfo is not an array
        }
