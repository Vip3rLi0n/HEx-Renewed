...
<html lang="en">
    ...
    <?php if ($css['uniform'] == 1) { ?>
        <link rel="stylesheet" href="css/uniform.css" />
    <?php } ?>
    
    <?php if ($css['wysiwyg'] == 1) { ?>
    ...
    <?php } else { ?>
        <!-- Font awesome custom library (menu) -->
    ...
    <div id="user-nav" class="navbar navbar-inverse">
        <ul class="nav btn-group">
            <li class="btn btn-inverse <?= $nav['profile']; ?>"><a href="profile.php"><i class="fa fa-inverse fa-user"></i> <span class="text"><?= _("My Profile"); ?></span></a></li>
            <li class="btn btn-inverse <?= $nav['mail']; ?>"><a href="mail"><i class="fa fa-inverse fa-envelope"></i> <span class="text"><?= _("E-Mail"); ?></span> <span class="mail-unread"></span></a></li>
            <li class="btn btn-inverse <?= $nav['settings']; ?>"><a href="settings"><i class="fa fa-inverse fa-wrench"></i> <span class="text"><?= _("Settings"); ?></span></a></li>
            <li class="btn btn-inverse"><a href="logout"><i class="fa fa-power-off fa-inverse"></i> <span class="text"><?= _("Logout"); ?></span></a></li>
        </ul>
    </div>
    <span id="notify"></span>
    <div id="sidebar">
        <a href="#" class="visible-phone"><i class="fa fa-inverse fa-chevron-down"></i> <?= _($sub); ?></a>
        <ul>
            <li <?= $menu['index']; ?>><a href="index"><i class="fa fa-inverse fa-home"></i> <span><?= _("Home"); ?></span></a></li>
            <li <?= $menu['processes']; ?>><a href="processes"><i class="fa fa-inverse fa-tasks"></i> <span><?= _("Task Manager"); ?></span></a></li>
            <li id="menu-software"<?= $menu['software']; ?>><a href="software"><i class="fa fa-inverse fa-folder-open"></i> <span><?= _("Software"); ?></span></a></li>
            <li id="menu-internet"<?= $menu['internet']; ?>><a href="internet"><i class="fa fa-inverse fa-globe"></i> <span><?= _("Internet"); ?></span></a></li>
            <li <?= $menu['log']; ?>><a href="log"><i class="fa fa-inverse fa-book"></i> <span><?= _("Log File"); ?></span></a></li>
            <li <?= $menu['hardware']; ?>><a href="hardware"><i class="fa fa-inverse fa-desktop"></i> <span><?= _("Hardware"); ?></span></a></li>
            <li <?= $menu['university']; ?>><a href="university"><i class="fa fa-inverse fa-flask"></i> <span><?= _("University"); ?></span></a></li>
            <li <?= $menu['finances']; ?>><a href="finances"><i class="fa fa-inverse fa-briefcase"></i> <span><?= _("Finances"); ?></span></a></li>
            <li <?= $menu['list']; ?>><a href="list"><i class="fa fa-inverse fa-terminal"></i> <span><?= _("Hacked Database"); ?></span></a></li>
            <li id="menu-mission"<?= $menu['missions']; ?>><a href="missions"><i class="fa fa-inverse fa-building-o"></i> <span><?= _("Missions"); ?></span></a></li> 
            <li <?= $menu['clan']; ?>><a href="clan"><i class="fa fa-inverse fa-users"></i> <span><?= _("Clan"); ?></span><?= $clanBadge; ?></a></li>
            <li <?= $menu['ranking']; ?>><a href="ranking.php"><i class="fa fa-inverse fa-bars"></i> <span><?= _("Ranking"); ?></span></a></li>
            <li <?= $menu['fame']; ?>><a href="fame.php"><i class="fa fa-inverse fa-star"></i> <span><?= _("Hall of Fame"); ?></span></a></li>
            <?= $doomMenu; ?>
        </ul>
    </div>
    <div id="content">
    <div id="content-header">
        <h1><?= _($sub); ?></h1>
        <div class="header-ip hide-phone" style="margin-top: 10px;">
            <div style="text-align: right;">
                <span class="header-ip-show" style="text-align: top;"><?php $idIP = $_SESSION['id']; require_once 'classes/PDO.class.php'; $pdo = PDO_DB::factory(); $session->newQuery(); $sql = 'SELECT gameIP FROM users WHERE id = \''.$_SESSION['id'].'\''; $userIP = long2ip($pdo->query($sql)->fetch(PDO::FETCH_OBJ)->gameip); echo $userIP; ?></span>
            </div>
            <div class="header-info">
                <div class="pull-right">
                    <span class="icon-tab he16-time" title="<?= _("Server Time"); ?>"></span>
                    <span class="small nomargin" style="margin-right: 7px;"><?= $clock; ?></span>
                    <span class="online"></span>
                    <div class="reputation-info">
                        <!--<div style="float: left;">
                            <span class="small nomargin item" title="Reputation">190,437</span>
                            <span class="small" title="Ranking">(#13)</span>
                        </div>-->
                    </div>
    ...
    <div id="breadcrumb">
        <a href="index" title="Go to Home" class="tip-bottom"><i class="fa fa-home"></i> <?= _("Home"); ?></a>
        <?php
        ...
        $link = isset($headerArr[$i]['link']) ? $headerArr[$i]['link'] : '';
        $name = isset($headerArr[$i]['name']) ? _($headerArr[$i]['name']) : '';
        ?>
        <a href="<?= $link ?>" id="link<?= $i ?>" <?= $cur ?>><?= $name ?></a>
    </div>
