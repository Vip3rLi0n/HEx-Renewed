...
# Insert softwares that belong to the NPC but are not there

cur.execute("""
    SELECT software_original.npcID, software_original.softName, software_original.softVersion, software_original.softSize,
...
# Run original software that should be running but it's not
