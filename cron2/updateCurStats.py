...
cur.execute("""
    SELECT h.userID, s.exp, s.dateJoined, s.timePlaying, s.bitcoinSent, s.warezSent, s.spamSent, 
    ...
    for ddos in cur.fetchall():
        ...
        cur.execute("""
            ...
            SET 
                ...
                moneyResearch = %s
            WHERE userID = %s
        """, (exp, dateJoined, cid, cname, timePlaying, warezSent, spamSent, bitcoinSent, profileViews, hackCount, ddos, ipResets, moneyEarned, moneyTransfered, moneyHardware, moneyResearch, userID))
